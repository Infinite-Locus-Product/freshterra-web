      ...
      <Container size="full" className="max-w-[1440px]">
        ...
        <div className="mb-12 grid gap-8 lg:grid-cols-2">
          ...
          <article>
            ...
            <Body size="md" className="mt-5 text-[18px] leading-7 tracking-normal">
            ...
            {content.partnerships.quotes.map((partner) => (
              ...
              >
                ...
                <div className="flex flex-col justify-between gap-6">
                  ...
                  <div>
                    <h4 className="font-display text-[28px] font-semibold">{partner.name}</h4>
                    <p
                      className={[
                        "text-base",
                        partner.theme === "amber" && "text-[#7f581b]",
        ...
        <section>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {content.sustainability.items.map((item) => (
              ...
              >
                <p className="font-sans text-2xl font-semibold leading-tight">{item}</p>
              </article>
            ))}
          </div>
        </section>
