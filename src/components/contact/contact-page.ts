...
export const contactPageSectionsClass =
  "mt-8 grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start";
...
export const contactGetInTouchCardClass =
  "mt-6 box-border w-full max-w-[41rem] lg:min-h-[23.9375rem] lg:rounded-[0.9075rem] lg:border lg:border-gray-200 lg:bg-white lg:p-8 lg:shadow-[0px_2px_10px_rgba(0,0,0,0.06)]";
...
/** Get In Touch row label (e.g. Head office) — mWeb: Manrope 16px medium, 20px line-height. */
export const contactInfoRowLabelClass =
  "text-text-primary font-sans text-base font-medium leading-5 tracking-[0] lg:text-[0.875rem] lg:font-semibold lg:leading-tight";

/** Get In Touch row value lines — mWeb: Manrope 12px regular, 140% line-height. */
export const contactInfoRowLineClass =
  "text-text-secondary font-sans text-xs font-normal leading-[1.4] tracking-[0] lg:text-[0.8125rem] lg:leading-relaxed";
