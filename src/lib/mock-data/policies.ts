    ...
    blocks: [
      {
        ...
        spans: [
          ...
          { text: ", or " },
          { text: '"us"', bold: true },
          { text: ") operates retail channels under the " },
          { text: "FreshTerra", bold: true },
          { text: " brand and other brands. " },
          { text: "FreshTerra", bold: true },
          { text: " is a retail brand licensed to " },
          { text: "F&W Foods Pvt. Ltd.", bold: true },
          { text: " by the licensor. This Refunds & Returns Policy (" },
          { text: '"Policy"', bold: true },
          {
            text: ") governs all purchases made through any channel operated by the Company — online and offline.",
          },
        ],
      },
      {
