...
/** Selected facet values keyed by group, e.g. `{ dietary: ["organic"] }`. */
...
/**
 * Static facet groups matching the SRP design. NOTE: these are placeholders
 * until the real facet contract lands — the API returns `facets` in the
 * results payload, so this should eventually be driven by that response.
 */
